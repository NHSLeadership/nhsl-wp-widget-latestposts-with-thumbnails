...
function nightingale_load_widget() {
  register_widget( 'nightingale_latest_posts_widget' );
}
add_action( 'widgets_init', 'nightingale_load_widget' );

// Create the widget 
class nightingale_latest_posts_widget extends WP_Widget {

  function __construct() {
    parent::__construct(

    // Base ID of widget
    'nightingale_latest_posts_widget', 

    // Widget name that will appear in dashboard
    __('Latest Posts with Thumbnails', 'nightingale_latest_posts_widget_domain'), 

    // Widget description that will appear in dashboard
    array( 'description' => __( 'Displays latest posts with thumbnails', 'nightingale_latest_posts_widget_domain' ), ) 
  );
}
...
public function form( $instance ) {
  if ( isset( $instance[ 'title' ] ) ) {
    ...
    $title = __( 'Latest Posts', 'nightingale_latest_posts_widget_domain' );
  }
